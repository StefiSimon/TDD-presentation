    ...
    render() {
        return (
            <div className="demo-container">
                ...
                <i className="fa fa-angle-left demo-fa" onClick={this.previousStep}></i>
                <i className="arrow-right fa fa-angle-right demo-fa" onClick={this.nextStep}></i>
